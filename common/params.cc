...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"FordCcInhibitHeartbeat", PERSISTENT},
    {"FordCcSteerIndicator", PERSISTENT},
    {"FordCcSteerIndicatorMode", PERSISTENT},
    {"FordSteerRateProfile", PERSISTENT},
    {"FordEnableBpLanePositioning", PERSISTENT},
    {"FordLatTuningEnableLanePositioning", PERSISTENT},
    {"FordLatTuningCustomPathOffset", PERSISTENT},
    {"FordLatTuningEnableLanefullMode", PERSISTENT},
    {"FordLatTuningLCPIDGainUI", PERSISTENT},
    {"FordLatTuningPathOffsetLookupTime", PERSISTENT},
    ...
    {"WebBindAll", PERSISTENT},
    {"WebPortalEnabled", PERSISTENT},
    {"WebPortalPort", PERSISTENT},
    {"WebPortalCrashCount", PERSISTENT},
    {"WebPortalLastCrash", PERSISTENT},
