  ...
  def update(self, CC, sm, CS, now_nanos):
    ...
    if (self.frame % CarControllerParams.STEER_STEP) == 0:
      ...
      if self.CP.carFingerprint in CANFD_CARS:
        ...
        can_sends.append(create_lat_ctl2_msg(self.packer, mode, -path_offset, 0., -apply_curvature, 0., counter))
      else:
        can_sends.append(create_lat_ctl_msg(self.packer, CC.latActive, -path_offset, 0., -apply_curvature, 0.))
