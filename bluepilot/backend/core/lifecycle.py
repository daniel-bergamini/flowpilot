...
def record_crash(params):
    ...
    try:
        ...
        try:
            crash_count_str = params.get("WebPortalCrashCount")
        ...
        try:
            last_crash_str = params.get("WebPortalLastCrash")
        ...
        try:
            params.put("WebPortalCrashCount", min(crash_count, 10))  # Cap at 10
            params.put("WebPortalLastCrash", current_time)
...
def check_and_handle_crashes(params):
    ...
    try:
        ...
        if crash_count > 0 and current_time - last_crash > 600:  # 10 minutes
            ...
            try:
                params.put("WebPortalCrashCount", 0)
                params.put("WebPortalLastCrash", 0)
            except AttributeError:
                # Mock params object doesn't have put methods, skip
                pass
