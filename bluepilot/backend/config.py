...
# Cache directories
DATA_ROOT = os.path.join(str(Path.home()), ".flowdrive", "bluepilot", "routes")
...
# User preferences
BLUEPILOT_DATA_DIR = os.path.join(str(Path.home()), ".flowdrive", "bluepilot")
...
def find_ffmpeg_binary():
    ...
    fallback_paths = [
        ...
        os.path.join(BASEDIR, 'third_party', 'ffmpeg'),
